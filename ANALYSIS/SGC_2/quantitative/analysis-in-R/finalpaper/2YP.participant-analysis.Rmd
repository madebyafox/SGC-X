...
No, they do not appear to be correlated
```{r echo = FALSE}
#EXPLORE time and score data via scatterplot
...
table <- tabular(  (INTERPRETATION+1)~(Format(digits=3)
                                    *(Heading("Score")*triangular_score)*(1+mean+sd)
