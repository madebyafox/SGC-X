...
test_items = subset(all_items, scenario!="jones", select = c("subject","condition", "experiment", "scenario","question","correct","graph")) #create a wide form

tri_items = subset(all_items, graph=="triangular", select = c("subject","condition","experiment","scenario","question","correct"))
lin_items = subset(all_items, graph=="linear", select = c("subject","condition","experiment","scenario","question","correct"))
...
df_correct$avg <- df_correct$Freq/318
