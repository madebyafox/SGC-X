...
#update factor level order in order to maximize comparison in graph
...
ggplot(data = l_questions, aes (x = q, y=count, fill=answer_type))+
  ...
  scale_fill_manual(values = c("#cacec8", "#FBEEBB", "#BCD9EE","#c6edbb"))
...
What are the alternative (wrong) answers subjects give for the first question?
