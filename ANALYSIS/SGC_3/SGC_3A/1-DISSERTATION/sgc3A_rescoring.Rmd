...
_The purpose of this notebook is to **rescore** the response data for the SGC_3A study.  This is required because the question type on the graph comprehension task used a 'Multiple Answer Multiple Choice' design (MCMA)._  
...
## Calculate Interpretation Scores

Finally, we calculate the scores, based on the calculated values for $i$. 
```{r SCORE-I}
