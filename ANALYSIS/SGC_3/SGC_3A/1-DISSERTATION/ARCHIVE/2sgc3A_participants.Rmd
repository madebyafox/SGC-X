...
*The purpose of this notebook is to analyze _participant-level data_ collected for study SGC-3A: The Insight Hypothesis *
...
fall_17 <- read.csv("data/fall17_sgc3a_participants.csv")
spring_18 <- read.csv("data/spring18_sgc3a_participants.csv")
fall_21 <- read.csv("data/fall21_sgc3a_participants.csv")
winter_22 <- read.csv("data/winter22_sgc3a_participants.csv")
