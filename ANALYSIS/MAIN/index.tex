...
\subcaption{\label{fig-control}\textbf{?(caption)}}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\subcaption{\label{fig-impasse}\textbf{?(caption)}}
\end{minipage}%
...
\addcontentsline{toc}{subsection}{Response Scoring}
...
\CommentTok{\#TODO SPECIAL SUBSCORES}
...
\CommentTok{\# alt\_scored = df\_items}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df\_items}\SpecialCharTok{$}\NormalTok{sorted\_interpretation }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(df\_items}\SpecialCharTok{$}\NormalTok{best,}
                                  \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Triangular"}\NormalTok{, }\StringTok{"Tversky"}\NormalTok{, }\StringTok{"both tri + orth"}\NormalTok{,}
                                             \StringTok{"reference"}\NormalTok{,}\StringTok{"frenzy"}\NormalTok{,}\StringTok{"blank"}\NormalTok{,}\StringTok{"?"}\NormalTok{,}
                                             \StringTok{"Satisfice"}\NormalTok{, }\StringTok{"Orthogonal"}\NormalTok{))}
...
\NormalTok{df\_items}\SpecialCharTok{$}\NormalTok{score\_SCALED }\OtherTok{\textless{}{-}} \FunctionTok{recode}\NormalTok{(df\_items}\SpecialCharTok{$}\NormalTok{interpretation,}
                          ...
                          \StringTok{"frenzy"} \OtherTok{=} \DecValTok{0}\NormalTok{,}
                          \StringTok{"?"} \OtherTok{=} \DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#VISUALIZE distribution of interpretations across all ITEMS}


\CommentTok{\#REORDER INTERPRETATION LEVELS}
\NormalTok{df\_items}\SpecialCharTok{$}\NormalTok{interpretation }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(df\_items}\SpecialCharTok{$}\NormalTok{interpretation, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Triangular"}\NormalTok{, }\StringTok{"Tversky"}\NormalTok{, }\StringTok{"both tri + orth"}\NormalTok{, }\StringTok{"blank"}\NormalTok{, }\StringTok{"?"}\NormalTok{, }\StringTok{"frenzy"}\NormalTok{,}\StringTok{"reference"}\NormalTok{,}\StringTok{"Satisfice"}\NormalTok{, }\StringTok{"Orthogonal"}\NormalTok{))            }
