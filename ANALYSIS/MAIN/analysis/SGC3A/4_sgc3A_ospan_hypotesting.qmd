...
compare_models(Bmm.cat.CrSQ, Bmm.cat.C.OrSQ, Bmm.cat.COrSQ)
# compare_performance(Bmm.cat.CrSQ, Bmm.cat.COrSQ)
# car::Anova(mm.cat.CrSQ, mm.cat.COrSQ)
# car::Anova(mm.cat.COrSQ)


##COMPARE SIMPLE TO INTERACTION
# print("Is interaction term justified?")
# (bf1 <- bayes_factor(Bmm.cat.COrSQ, Bmm.cat.C.OrSQ))
```
