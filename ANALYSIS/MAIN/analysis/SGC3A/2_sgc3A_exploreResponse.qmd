...
|---------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|
| ![](keys/control/interpretations/Q1_111_TRI.png)              | ![](keys/control/interpretations/Q1_111_TVERSKY.png)                                                                                    | ![](keys/control/interpretations/Q1_111_ORTH.png)                          |
| indicates the correct interpretation of the coordinate system | a triangular-like interpretation, where the respondent selects any datapoints intersecting the lines that connect to the reference time | indicates the incorrect, Cartesian interpretation of the coordinate system |
