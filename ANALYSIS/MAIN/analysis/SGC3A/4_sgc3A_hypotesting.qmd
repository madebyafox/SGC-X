...
A score of 100% indicates that the participant correctly interpreted the interval-coordinate system throughout the task, _starting at the first question_. A score of 0% indicates the individual _never_ correctly interpreted the coordinate system. A score somewhere inbetween indicates that an individual deciphered the coordinate system _sometime over the course the task_. 
