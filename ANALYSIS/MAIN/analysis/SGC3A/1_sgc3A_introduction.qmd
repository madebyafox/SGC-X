...
study_dir = "analysis/SGC3A/"

#IMPORT DATA 
df_subjects <- read_rds('analysis/SGC3A/data/1-study-level/sgc3a_participants.rds')
df_subjects <- read_csv('analysis/SGC3A/data/1-study-level/sgc3a_participants.csv') 
...
write.csv(df_freeresponse,"analysis/SGC3A/data/1-study-level/sgc3a_items.csv", row.names = FALSE)
