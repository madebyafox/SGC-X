...
-   `score_SAT_left` How consistent is the response with the **(left) Satisficing**interpretation?
-   `score_SAT_right` How consistent is the response with the **(right) Satisficing**interpretation?
