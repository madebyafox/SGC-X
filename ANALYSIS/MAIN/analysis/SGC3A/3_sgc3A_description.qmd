...
ggplot(df_subjects, aes(x = pretty_condition, y = item_test_NABS, fill = pretty_condition)) + 
  ggdist::stat_halfeye(
    adjust = .5, 
    width = .6, 
    .width = 0, 
...
##RAINCLOUD USING GGDISTR
ggplot(df_subjects, aes(x = pretty_condition, y = item_test_SCALED, fill = pretty_condition)) + 
  ggdist::stat_halfeye(
    adjust = .5, 
    width = .6, 
    .width = 0, 
