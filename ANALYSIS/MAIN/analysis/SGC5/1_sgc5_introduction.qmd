...
#IMPORT DATA 
df_subjects <- read_csv('analysis/SGC5/data/0-study-level/sgc5_participants.csv') 
...
#import file
df_subjects <- read_rds("analysis/SGC5/data/0-study-level/sgc5_participants.rds") #use RDS file as it contains metadata
...
#read datafiles
df_items <- read_rds("analysis/SGC5/data/0-study-level/sgc5_items.rds") #use RDS file as it contains metadata
...
#SAVE FILES
write.csv(df_subjects,"analysis/SGC5/data/1-study-level/sgc5_participants.csv", row.names = FALSE)
write.csv(df_items,"analysis/SGC5/data/1-study-level/sgc5_items.csv", row.names = FALSE)
write.csv(df_q16,"analysis/SGC5/data/1-study-level/sgc5_freeresponse.csv", row.names = FALSE)

#SAVE R Data Structures 
#export R DATA STRUCTURES (include codebook metadata)
rio::export(df_subjects, "analysis/SGC5/data/1-study-level/sgc5_participants.rds") # to R data structure file
rio::export(df_items, "analysis/SGC5/data/1-study-level/sgc5_items.rds") # to R data structure file

```

### Response Scoring

Because the graph comprehension task utilizes a Multiple-Response (MR) format (rather than simple multiple choice), the raw response data (the combination of answer options selected) for each question first need to be assigned a score. Approaches to scoring MR data and score transformations are derived in [Section -@sec-SGC5-scoring].

### Hypothesis Testing

Experimental hypotheses are tested in [Section -@sec-SGC5-hypotesting].

### Exploratory Analysis

Further data analyses are documented in [Section -@sec-SGC5-exploration].
