---
# title: 'Introduction' 
subtitle: 'Study SGC4B | 1 Introduction'
---

\newpage

# Introduction {#sec-SGC4B-introduction}
...
: **SGC4B Study Conditions** {tbl-colwidths="\[40,60\]"}
...
#IMPORT DATA 
df_subjects <- read_rds('analysis/SGC4B/data/0-study-level/sgc4b_participants.rds')
...
### Data Preparation {#sec-SGC4B-harmonize}
...
Because the graph comprehension task utilizes a Multiple-Response (MR) format (rather than simple multiple choice), the raw response data (the combination of answer options selected) for each question first need to be assigned a score. Approaches to scoring MR data and score transformations are derived in [Section -@sec-SGC4B-scoring].

### Hypothesis Testing

Experimental hypotheses are tested in [Section -@sec-SGC4B-hypotesting].

### Exploratory Analysis

Further data analyses are documented in [Section -@sec-SGC4B-exploration].
