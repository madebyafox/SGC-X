---
subtitle: 'Study SGC4 | 2 Response Scoring'
---
...
#backup <- read_rds('data/1-study-level/sgc3a_items.rds') #for troubleshooting only
...
The final output is called `best`.
...
write.csv(df_absolute_progress,"data/2-scored-data/sgc3a_absolute_progress.csv", row.names = FALSE)
write.csv(df_scaled_progress,"data/2-scored-data/sgc3a_scaled_progress.csv", row.names = FALSE)
