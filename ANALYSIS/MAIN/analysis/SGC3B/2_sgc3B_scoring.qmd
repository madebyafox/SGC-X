---
subtitle: 'Study SGC3B | 2 Response Scoring'
---

\newpage

# Response Scoring {#sec-SGC3B-scoring}
...
### Prepare Answer Keys {#sec-SGC3B-keys}
...
### Calculate Subscores {#sec-SGC3B-subscores}
...
### Derive Interpretation {#sec-SGC3B-interpretation}
...
### Derive Scaled Score {#sec-SGC3B-scaledScore}
...
##### Q1. Impasse Conditions


![Question 1 --- Impasse Condition](analysis/SGC3A/static/questions/Q1_121.png){#fig-Q1-121}
...
df_items %>% filter(q == 1 & IMPASSE == "IMPASSE") %>% group_by(response) %>% 
  dplyr::summarise( count = n(), 
                    nice = unique(score_niceABS),
                    triangular = unique(score_TRI), 
                    orthogonal =  unique(score_ORTH),
...
df_items %>% filter(q == 2 & IMPASSE == "IMPASSE") %>% group_by(response) %>% 
  dplyr::summarise( count = n(), 
                    nice = unique(score_niceABS),
                    triangular = unique(score_TRI), 
                    orthogonal =  unique(score_ORTH),
...
df_items %>% filter(q == 3 & IMPASSE == "IMPASSE") %>% group_by(response) %>% 
  dplyr::summarise( count = n(), 
                    nice = unique(score_niceABS),
                    triangular = unique(score_TRI), 
                    orthogonal =  unique(score_ORTH),
...
df_items %>% filter(q == 4 & IMPASSE == "IMPASSE") %>% group_by(response) %>% 
  dplyr::summarise( count = n(), 
                    nice = unique(score_niceABS),
                    triangular = unique(score_TRI), 
                    orthogonal =  unique(score_ORTH),
...
df_items %>% filter(q == 5 & IMPASSE == "IMPASSE") %>% group_by(response) %>% 
  dplyr::summarise( count = n(), 
                    nice = unique(score_niceABS),
                    triangular = unique(score_TRI), 
                    orthogonal =  unique(score_ORTH),
