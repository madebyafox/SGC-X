...
### WIP WIP MULTINOMIAL REGRESSION \[INTERPRETATION\]
...
# write_rds(mm1, "analysis/models/sgc3a_brms_mixedcat_teststate.rds")
# mm1 <- read_rds("analysis/models/sgc3a_brms_mixedcat_teststate.rds")
# summary(mm1)
# performance(mm1)
# plot(mm1)
# #report(mm1)
...
# plot(rope(mm1))
```
_Likelihood ratio test indicates predictor model is significantly better fit to the sample data than the empty (intercept only) model._
