---
title: "Spring 2018 Data Cleaning"
author: "Amy Rae Fox"
date: "11/2/2021"
output:
...
In Spring 2018, exclusion criteria were implemented in the database data wrangling step. To reconcile number of submissions (vs) number of successfully completed we compare the number of entries in the analysis database, (vs) the number of entries in the imported analysis file (post-db-wrangling).
...
Manual inspection of database after importing Spring 2018 data indicates:

-   SGC3A

    -   90 submitted (111: 41, 121: 50)
    -   84 wrangled (imported 111:39; imported 121: 45)
    -   thus 90 - 84 = 6 were excluded for failing the attention check
    -   note that 12 of the remaining 84 successful SGC3A records are for test or narrative interview sessions ("strategy-connecting","strategy-satisficing","mouse"). Only 72 participants are included in the SGC3A analysis.
