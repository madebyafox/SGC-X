...
*note* : We drop all scores calcluated in the stimulus engine, as they are recalculate during analysis using a different MC scoring algorithm.
...
select(-explanation,
    - absolute_score, -discriminant_score, -tri_score, -orth_score, -other_score, -blank_score)  %>%
mutate(
  condition= as.character(condition),
  subject = as.character(subject))
